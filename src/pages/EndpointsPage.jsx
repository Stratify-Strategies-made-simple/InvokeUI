      ...
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <h2 className="text-xl font-bold text-gray-900">Active Deployments</h2>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="flex gap-2">
                        <code className="flex-1 px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-800 font-mono truncate">
                          {endpoint.url}
                        </code>
                        <button 
                          onClick={() => handleCopy(endpoint.url, `${endpoint.id}-url`)}
                          className="px-3 py-2 border border-gray-200 rounded-lg text-gray-600 hover:bg-gray-50 flex items-center gap-2"
                        >
                    ...
                    <div>
                      <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Authentication Key</label>
                      <div className="flex gap-2">
                        <code className="flex-1 px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-800 font-mono truncate">
                          {endpoint.key}
                        </code>
          ...
          <div className="space-y-6">
            <div className="bg-indigo-600 rounded-2xl p-6 text-white shadow-lg">
              <Code className="w-8 h-8 text-indigo-300 mb-4" />
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-sm text-gray-500 mb-4">Read our documentation on deploying agent teams securely to production.</p>
