      ...
      <div className="max-w-[1400px] mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <div className="hidden lg:flex items-center gap-6">
            <button
              onClick={() => { setSelectedSpace(null); navigate("/"); }}
              className={`flex items-center gap-1.5 text-sm font-bold ${currentPath === "/" ? "text-gray-900" : "text-gray-500 hover:text-gray-900"}`}
            >
              Home
            </button>
            <button
              onClick={() => { setSelectedSpace(null); navigate("/spaces"); }}
              className={`flex items-center gap-1.5 text-sm font-bold ${currentPath === "/spaces" ? "text-gray-900" : "text-gray-500 hover:text-gray-900"}`}
            >
              Spaces
            </button>
            <button
              onClick={() => { setSelectedSpace(null); navigate("/tools"); }}
              className={`flex items-center gap-1.5 text-sm font-bold ${currentPath === "/tools" ? "text-gray-900" : "text-gray-500 hover:text-gray-900"}`}
            >
              Tools
            </button>
            <button
              ...
              className={`flex items-center gap-1.5 text-sm font-bold ${currentPath === "/library" ? "text-gray-900" : "text-gray-500 hover:text-gray-900"}`}
            >
              Library
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 flex flex-col">
      ...
      <main className="flex-1">
        <Routes>
          <Route path="/" element={<HomePage onNavigate={navigate} onLogin={handleLogin} />} />
          <Route path="/privacy" element={<PrivacyPolicy />} />
          <Route path="/terms" element={<TermsOfService />} />
          <Route path="/prompts" element={<PromptsCollection />} />
